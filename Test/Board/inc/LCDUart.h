...
#define MenuViewListMeasure2 60
...
/* wk @20131020 --> 列表显示界面更新*/
#define MenuViewHarmoListU1 28  //1-26次
#define MenuViewHarmoListU2 13  // 25-50次
#define MenuViewHarmoListI1 29  //1-26次
#define MenuViewHarmoListI2 14  // 25-50次
#define MenuViewHarmoListHYL1 12  //1-26次含有率
#define MenuViewHarmoListHYL2 17  // 25-50次

#define MenuViewHarmoListS1 62 //视在电能 1-26
#define MenuViewHarmoListS2 65 //
#define MenuViewHarmoListQ1 63 //无功电能 1-26
#define MenuViewHarmoListQ2 66 //
#define MenuViewHarmoListP1 64 //有功电能 1-26
#define MenuViewHarmoListP2 67 //
#define PageStart2 72
#define PageStart3 71
#define PageStart4 70
#define PageStart5 69
#define PageStart6 68
...
extern volatile U8 HarmoListPower;
extern volatile U8 DataListPg;
